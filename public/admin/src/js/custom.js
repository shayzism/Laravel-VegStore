        ...
        var mybarChart = new Chart(ctx, {
            ...
            data: {
                ...
                datasets: [{
                    ...
                    {
                        label: 'مربا',
                        backgroundColor: "#f5696c",
                        data: [43, 16, 45, 28, 62, 74, 11]
                    },
                    {
                        label: 'بقیه',
                        backgroundColor: "#006a2f",
                        data: [56,12,74,37,61,03,95]
                    }]
            },
...
function init_morris_charts() {
    ...
    if ($('#graph_bar').length) {
        ...
        Morris.Bar({
            element: 'graph_bar',
            data: [
                {device: 'بررسی کامنت', geekbench: 1371},
                {device: ' بررسی پست ها', geekbench: 1471},
                {device: 'کالا های فروخته شده', geekbench: 2371},
                {device: 'کاربر اضافه کرده', geekbench: 1144},
