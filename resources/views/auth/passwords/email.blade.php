...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header text-right" style="background-color: #82ae46;color: white;font-size: 18px;">{{ __('بازیابی رمز عبور') }}</div>
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('password.email') }}">
                        ...
                        <div class="form-group row">
                            <label for="phone_number" class="col-md-4 col-form-label text-md-right">{{ __('شماره تماس') }}</label>
